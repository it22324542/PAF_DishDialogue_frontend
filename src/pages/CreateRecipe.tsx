...
const CreateRecipe: React.FC = () => {
  ...
  const onSubmit = async (data: RecipeFormValues) => {
    if (!imageFile) {
      setImageError('Please select an image for your recipe');
      return;
    }
    ...
    try {
      ...
      try {
        ...
        // Fall back to using a placeholder image
  ...
  return (
    <div className="pt-4 pb-20 md:pb-8">
      ...
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-xl font-semibold text-center flex-1">Create New Recipe</h1>
      </div>
